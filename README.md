...
Chat rooms project created with Python's Flask and Flask_socketIO. Flask powers the backend and SocketIO is used to redirect users to different rooms. Front-end will also be worked on, aiming for an aesthetic and user-friendly chat UI.
